...
###########################################
wkuinf = read.table("./data/hourly_cases_02.txt",header=T,sep="")
#######################################
...
{  
  ...
  P_chi_sq   = sum(((y_pred)-wkuinf[[2]])^2/(y_pred))
  #P_chi_sq   = sum(((y_pred)-wkuinf[[2]])/sqrt(y_pred))
  ...
  if (P_chi_sq < upperbound){
    ...
    plot(wkuinf$sno, wkuinf$ccases, xlab = 'time (hourly)', ylab = "cum. # of cases",
         type = 'p', lwd = 3, pch = 20, col = 'gray', ylim = c(0, 350))
    
    # Plot the fitted model
    lines(wkuinf$sno, y_bfit, col = 'red', lwd = 2)
    ...
    polygon(c(wkuinf$sno, rev(wkuinf$sno)), c(upper_bound, rev(lower_bound)),
