...
write.csv(result, "./hist5.csv", row.names = FALSE)
...
# Load the data
data <- read.csv("./hourly_data_full.csv")
...
# Load the data
data <- read.csv("./hourly_data_with_cumulative.csv")
...
data <- read.csv("./daily_data_full_N1_ssm.csv")
...
case <- read.csv("./daily_data_full_N1_ssm.csv")
